...
from cat._source   import _constant
from array         import *
from math          import *
...
class _srw_electron_beam(object):
    ...
    def __init__(self, electron_beam, n_period, period_length, n_hormonic):
...
class _undulator(object):
    ...
    def cal_k(self, electron_beam_energy = 6):
        ...
        self.k = np.sqrt(
            2 * (((2 * self.n_hormonic * self.wavelength * gamma**2) / self.period_length) - 1)
            )
